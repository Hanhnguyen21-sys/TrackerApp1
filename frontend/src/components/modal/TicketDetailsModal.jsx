        ...
        <div className="flex items-center justify-between gap-4 border-b border-slate-800 px-6 py-5">
          <div>
            ...
            <p className="text-sm text-slate-400">
              All ticket information, comments, mentions, and activity.
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="grid gap-6 p-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <section className="space-y-5">
            ...
            <div className="rounded-3xl border border-slate-800 bg-slate-900 p-5">
              ...
              <div className="mt-5 max-h-[420px] space-y-0 overflow-y-auto pr-2">
                {activity.length === 0 ? (
                  ...
                  activity.map((entry, index) => (
                    <div key={entry._id} className="relative flex gap-4 pb-5">
                      ...
                      {/* content */}
                      <div className="flex-1 rounded-2xl border border-slate-800 bg-slate-950 p-4">
